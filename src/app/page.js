...
export default async function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="md:absolute right-4 top-8 w-1/3 h-1/2">
      ...
      <div className="md:absolute md:bottom-4 w-full flex flex-col md:flex-row items-start justify-between px-10 h-fit">
        ...
        <StickyNote className="grow-0 aspect-square -rotate-2 text-center font-bold p-2 font-spg text-2xl  bg-spg-blue w-64 text-white">
          The Seattle Printers' Guild provides free workshops in the King County
          area.
        </StickyNote>
        <StickyNote className="grow-0 aspect-square rotate-6 text-white font-bold text-center p-2 font-spg text-2xl bg-spg-green w-64 ">
          <div>
